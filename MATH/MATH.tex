...
\end{itemize}
\section{Fonctions de la variable réelle [sup 5]}
...
\begin{itemize}
    ...
    \item Toute fonction $f$ s'écrit comme somme d'une fonction paire $ \frac{f(x) + f(-x)}{2} $ et une fonction impaire $ \frac{f(x)-f(-x)}{2} $.
...
\begin{itemize}
    ...
    \item La bijection réciproque d'une fonction strictement monotone est strictement monotone et de même sens de variation. 
\end{itemize}
...
\clearpage
\section{Fonctions usuelles [sup 6]}
...
\begin{itemize}
    ...
    \item Les ssevs d'un K-ev est un K-ev - on peut donc démontrer un K-ev en montrant qu'il s'agit d'un ssev d'un K-ev connu. 
...
\begin{itemize}
    ...
    \item Pour $\dim E = \dim F$, des conditions suffisantes de bijectivité - 
    \begin{itemize}
        \item $u$ injective
        \item $u$ surjective
...
\subsection{Définition}
\begin{itemize}
    \item Application de $\Omega \rightarrow X(\Omega)$
    \item $X(\Omega)$ l'ensemble des variables tirées des résultats
