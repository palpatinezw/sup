...
\begin{enumerate}
    \item On pose $x = u(t)$ avec $u \in \mathcal{C}^0$
...
\begin{enumerate}
    \item On pose $u'$ et on obtient $u$ en intégrant, avec $u \in \mathcal{C}^0$
    \item On pose $v \in \mathcal{C}^0$ et on obtient $v'$
\end{enumerate}
...
\[ {m + n \choose p} = \sum_{k=0}^p {m \choose k}{n \choose p-k}  \]
