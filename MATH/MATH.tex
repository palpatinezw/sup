...
\begin{itemize}
    ...
    \item Point critique - $\nabla f (a) = 0$
    \begin{itemize}
        \item $\nabla f (a) = 0$ est une condition nécessaire d'extrema
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item $ f \circ \gamma : \mathbb{R} \in \mathbb{R} $
    ...
    \end{itemize}
    \item Cas $\Phi = (\phi_1 : \mathbb{R}^2 \rightarrow \mathbb{R}, \phi_2 : \mathbb{R}^2 \rightarrow \mathbb{R}) : \mathbb{R}^2 \rightarrow \mathbb{R}^2, f : \text{Im}(\Phi) \rightarrow \mathbb{R}$
    \begin{itemize}
        \item $ f \circ \Phi = \mathbb{R}^2 \rightarrow \mathbb{R} $
