...
\begin{itemize}
    ...
    \item On note $j=e^{i\frac{2\pi}{3}} = -\frac{1}{2} + i \frac{\sqrt{3}}{2} \in \mathbb{U}_3$
...
\\ \\
\noindent Ce formule est valable pour tout objet mathématique dont la loi $\times$ est communtative (e.g. matrices qui commutent, polynômes)
...
\noindent La dérivée d'une fonction paire est impaire et la dérivée d'une fonction impaire est paire. 
...
\begin{itemize}
    \item Matrices équivalentes - il existe des matrices inversibles $P$ et $Q$ tel que $B = QAP$
    \begin{itemize}
        \item $A \et B$ sont équivalentes $\iff A \et B$ représentent la même application linéaire
    \end{itemize} 
    \item Matrices semblables (HP) - il existe une matrice inversible $P$ tel que $B = P^{-1}AP$
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Problème de Cauchy - si on pose $y(x_0) = y_0 \et y'(x_0) = y_1$, il existe une unique solution
\end{itemize}
