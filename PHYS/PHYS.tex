...
\begin{itemize}
    ...
    \item $\beta = \frac{1}{\beta}\frac{\partial P}{\partial T}|_V$ - Coefficient de dilatation isochore
\end{itemize}
...
\[ dE_{m\repr} + dU = \delta W_{\repr} + \delta Q \]
...
\begin{itemize}
    \item À basses températures, on a uniquement les translations, $U = \frac{3}{2}k_BT$ comme pour des gaz monoatomiques
    \item À températures ambiantes, on a les translations et les rotations, mais pas de vibrations, $U = \frac{5}{2}k_BT$
    \item À hautes températures, on a les translations, les rotations, et les vibrations, $U = \frac{7}{2}k_BT$
\end{itemize}
...
\begin{itemize}
    \item Par définition, $\dd U = C_V \dd T \et \dd H = C_P \dd T$
