...
\subsubsection{Travail mécanique de la pression}
\[ \delta W = - P_{\text{contact}} dV \]

\begin{itemize}
    \item Pour une transformation quasi-statique et mécaniquement réversible, $P_{\text{contact}} = P$ du système, donc $ \delta W = - P dV $
