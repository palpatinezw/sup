...
\begin{itemize}
    ...
    \item Pour un système de centre d'inertie $G$ on a - $ m \vec{a}_{\repr}(G) = \sum_{\text{ext}} \vec{F} $
\end{itemize}
...
\noindent Pour un système $\mathcal{S}$ indéformable en rotation autour d'un axe $\Delta$
