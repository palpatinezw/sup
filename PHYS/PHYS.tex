...
\noindent Intéférence avec 2 sources ponctuelles, séparées par une distance $a$ et de distance $D$ de l'écran
\begin{itemize}
    \item Interfrange $ i = \frac{D\lambda}{a} $ [Démonstration - On détermine $d_2 - d_1 = \frac{xa}{D}$ avec une développement limitée et on étudie l'amplitude à l'écran qui dépend du phase $\phi_i - \frac{2\pi}{\lambda}d_i$]
\end{itemize} 
\noindent 
...
\noindent On peut étudier la déviation $D = \theta - \theta_i$
...
\begin{itemize}
    ...
    \item Factorisation de cosinus - $ \cos{p} + \cos{q} = \cos{\frac{p+q}{2}}\cos{\frac{p-q}{2}} $ 
    \item 
\end{itemize}
